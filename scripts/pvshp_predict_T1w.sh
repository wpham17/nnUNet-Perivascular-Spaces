...
# ./pvshp_predict_T1w.sh

# Input directory containing hippocampi extracted T1w images
# Regions outside the hippocampi should be masked out
...
nnUNetv2_predict -d Dataset778_PVSHC -i ${INPUT_DIR} -o ${OUTPUT_DIR} -f  0 1 2 3 4 -tr nnUNetTrainer -c 3d_fullres -p nnUNetResEncUNetMPlans
